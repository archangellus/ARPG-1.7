    ...
    public static class TooltipInstaller
    {
        ...
        public static void AddTooltipTriggerToSelection()
        {
            ...
            foreach (GameObject go in Selection.gameObjects)
            {
                ...
                if (trigger == null)
                {
                    trigger = Undo.AddComponent<TooltipTrigger>(go);
                    added++;
                }
                else
                {
            ...
            Debug.Log($"Added Tooltip Trigger to {added} selected uGUI element(s). Generated {generatedIds} tooltip id(s). Fill in the remaining Tooltip fields in the Inspector.");
        }
