...
namespace PLAYERTWO.ARPGProject
{
    ...
    public class Skill : ScriptableObject
    {
        ...
        /// <summary>
        /// Returns true if the given Entity is equipping the weapon required to perform this Skill.
        /// </summary>
        /// <param name="entity">The Entity attempting to perform this Skill.</param>
        public virtual bool IsRequiredWeaponEquipped(Entity entity)
        {
            return requiredWeapon switch
            {
                RequiredWeapon.Blade => entity.items.IsUsingBlade(),
                RequiredWeapon.Bow => entity.items.IsUsingBow(),
                _ => true,
            };
        }
