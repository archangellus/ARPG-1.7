...
namespace PLAYERTWO.ARPGProject
{
    ...
    {
        [Header("Damage Text")]
        [Tooltip("If true, damage text will be displayed when the Entity takes damage.")]
        ...
        [Tooltip("If true, damage particles will be played when the Entity takes damage.")]
        public bool showDamageParticle = true;
