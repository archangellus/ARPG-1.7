...
namespace PLAYERTWO.ARPGProject
{
            ...
            IDeselectHandler
    {
        ...
        public void OnPointerEnter(PointerEventData _)
        {
            ...
            m_inspecting = true;
            GUIInspectorManager.instance.skillInspector.SafeCall(i => i.Show(m_slot.skill));
#endif
        }
...
#if UNITY_STANDALONE || UNITY_WEBGL
            m_inspecting = false;
            GUIInspectorManager.instance.skillInspector.SafeCall(i => i.Hide());
#endif
        }
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            m_inspecting = true;
            GUIInspectorManager.instance.skillInspector.Hide();
            GUIInspectorManager.instance.skillInspector.Show(m_slot.skill);
            GUIInspectorManager.instance.skillInspector.SetPositionRelativeTo((RectTransform)transform);
