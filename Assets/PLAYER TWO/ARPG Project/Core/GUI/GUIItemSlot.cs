...
namespace PLAYERTWO.ARPGProject
{
...
#endif
    {
        ...
        /// <summary>
        /// Returns true if this slot's equipped item can accept a given Socketable GUI Item.
        /// </summary>
        /// <param name="other">The Socketable GUI Item you want to attach.</param>
        public virtual bool CanSocket(GUIItem other) => item && item.CanSocket(other);

        /// <summary>
        /// Tries to attach a given Socketable GUI Item to this slot's equipped item.
        /// </summary>
        /// <param name="other">The Socketable GUI Item you want to attach.</param>
        /// <returns>Returns true if the item was attached as a socket.</returns>
        public virtual bool TrySocket(GUIItem other) => item && item.TrySocket(other);
        ...
        /// <summary>
        /// Returns true if it successfully equips, stacks, or sockets the current selected GUI Item.
        /// </summary>
        ...
        public virtual void OnPointerDown(PointerEventData eventData)
        {
            ...
            {
                GUIInspectorManager.instance.itemInspector.Hide();
                GUIInspectorManager.instance.itemInspector.Show(item);
