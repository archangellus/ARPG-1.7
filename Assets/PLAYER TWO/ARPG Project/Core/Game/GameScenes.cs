...
namespace PLAYERTWO.ARPGProject
{
    ...
    public class GameScenes : Singleton<GameScenes>
    {
        ...
        /// <param name="loadingSprite">The sprite to display on the loading screen.</param>
        /// <param name="playTransitionAudio">If false, skips loadStartClip/loadFinishClip, letting the caller play its own transition audio instead.</param>
        public virtual void LoadScene(
            string scene,
            bool setAsCharacterScene = false,
            Sprite loadingSprite = null,
            bool playTransitionAudio = true
        )
        {
            ...
            Fader.instance.FadeOut(
                () => StartCoroutine(LoadSceneRoutine(scene, setAsCharacterScene, playTransitionAudio))
            );
