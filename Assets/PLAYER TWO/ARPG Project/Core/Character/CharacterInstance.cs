...
namespace PLAYERTWO.ARPGProject
{
    public class CharacterInstance
    {
        ...
        public Vector3 townPortalReturnPosition;
        public Quaternion townPortalReturnRotation;
        public Vector3 townPortalPosition;
        public Quaternion townPortalRotation;
        ...
        public static CharacterInstance CreateFromSerializer(CharacterSerializer serializer)
        {
            ...
            return new CharacterInstance()
            {
                ...
                usingTownPortal = serializer.usingTownPortal,
                townPortalReturnScene = serializer.townPortalReturnScene,
                townPortalReturnPosition = serializer.townPortalReturnPosition.ToUnity(),
                townPortalReturnRotation = Quaternion.Euler(
                    serializer.townPortalReturnRotation.ToUnity()
                ),
                townPortalPosition = serializer.townPortalPosition.ToUnity(),
                townPortalRotation = Quaternion.Euler(serializer.townPortalRotation.ToUnity()),
